...
public class UICamera : MonoBehaviour
{
    ...
    static public GameObject nowHover;
...
#if UNITY_FLASH
	 public static bool IsVisible (DepthEntry de)
#else
    public static bool IsVisible (ref DepthEntry de)
#endif
	{
...
#if UNITY_EDITOR &&!DLL_TYPE || UNITY_STANDALONE_WIN || UNITY_STANDALONE_OSX || UNITY_STANDALONE_LINUX
	...
	public void ProcessMouse ()
	{
        ...
        if (posChanged && mMouse[0].current != null) {
            Notify(mMouse[0].current, "OnOver", null);
        }
...
#if UNITY_STANDALONE_OSX || UNITY_EDITOR &&!DLL_TYPE_OSX
	...
	void ProcessRelease (bool isMouse, float drag)
	{
		...
		if (currentTouch.pressed != null)
		{
            ...
            Notify(currentTouch.current, "OnMouseUp", null);
